  ...
  const getVeggie = async () => {
    ...
    if (check) {
      ...
      try {
        ...
        console.log(data);
        localStorage.setItem("veggie", JSON.stringify(data.recipes)); //localStorige can save only strings thats why we have to strigefy our data.recepies
